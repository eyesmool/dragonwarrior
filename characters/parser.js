const parseHTML = () => {
    const csv = `"Hanzi (Simplified)","Pinyin","English"
    "啊","ā","ah"
    "啊","a","ah"
    "矮","ǎi","short; low"
    "爱","ài","love"
    "爱人","àirén","husband; wife; sweetheart"
    ...
    "帮助","bāngzhù","help; assist; aid"
    "饱","bǎo","be full"
    "抱","bào","hug; embrace"
    "报","bào","newspaper; gazette"
    "杯","bēi","cup; glass"
    "杯子","bēizi","cup; glass"
    "北","běi","north"
    "北边","běibiān","north; north side"
    "倍","bèi","times; -fold"
    "被","bèi","by"
    ...
    "遍","biàn","time"
    "表","biǎo","(錶) watch; (表) table; meter; chart"
    "表示","biǎoshì","show; express; indicate"
    "表现","biǎoxiàn","show off; express; display"
    "表演","biǎoyǎn","perform; act; play; demonstrate"
    "表扬","biǎoyáng","praise; commend"
    "别","bié","don't"
    "别的","biéde","other; another"
    "别人","biéren","other people; others"
    "病","bìng","disease; illness; sickness"
    "不","bù","not; no"
    "不错","bùcuò","not bad; pretty good; correct"
    "不但","bùdàn","not only"
    ...
    "参加","cānjiā","join; take part in; attend"
    ...
    "带","dài","take; do; lead; have"
    "代表","dàibiǎo","represent; representative; deputy"
    "但是","dànshì","but; however; yet, nevertheless"
    "当","dāng","at (a time or place); facing"
    "当","dāng","act as; accept; administer; stop"
    ...
    "点","diǎn","dot, point; dot stroke"
    "点","diǎn","a little; point"
    "点","diǎn","put a dot; count; select; light"
    "点心","diǎnxin","pastry; light refreshments"
    "点钟","diǎnzhōng","o'clock"
    "电","diàn","electricity"
    "电车","diànchē","tram; trolleybus"
    "电灯","diàndēng","electric light; electric lamp"
    "电话","diànhuà","telephone; phone; phone call"
    "电视","diànshì","television; TV"
    "电影","diànyǐng","film; movie"
    "掉","diào","fall; drop; lose; reduce; turn"
    "丢","diū","lose; throw; put aside"
    "东","dōng","east"
    "东边","dōngbiān","east"
    ...
    "动","dòng","move; stir; use"
    "动物","dòngwù","animal"
    "都","dōu","all; both; even; already"
    "读","dú","read; read aloud"
    "短","duǎn","short; brief"
    "锻炼","duànliàn","take exercise; physical training"
    "段","duàn","segment; period; paragraph"
    "对","duì","towards; treat; compare; aim at"
    "对","duì","right; correct"
    "对不起","duìbuqǐ","sorry; excuse me; let down"
    "顿","dùn","used for meals or scolding"
    ...
    "儿子","érzi","son"
    "二","èr","two"
    "发","fā","send out; discharge; issue; rise"
    "发烧","fā shāo","have a fever; have a temperature"
    "发生","fāshēng","happen; occur; take place"
    "发现","fāxiàn","discover; find; discovery"
    "发展","fāzhǎn","develop; recruit; development"
    "法语(法文)","fǎyǔ(fǎwén)","French; French language"
    "翻","fān","turn over; rummage; capsize"
    "翻译","fānyì","translate; translation; translator"
    "反对","fǎnduì","oppose; fight; be against"
    "饭","fàn","meal; cooked rice or other cereals"
    ...
    "干","gàn","do; work"
    "干部","gànbù","cadre"
    "刚","gāng","just; barely; only just"
    "刚才","gāngcái","a moment ago; just now"
    "钢笔","gāngbǐ","pen"
    "高","gāo","tall; high; of a high degree"
    "高兴","gāoxìng","glad; cheerful; be happy to"
    ...
    "公里","gōnglǐ","kilometer"
    "公园","gōngyuán","park"
    "够","gòu","be enough; be up to; reach; quite"
    "姑娘","gūniang","girl; daughter"
    "故事","gùshi","story; tale"
    "刮","guā","(刮) scrape; shave; smear with; (颳) blow"
    "挂","guà","hang; call up; ring off"
    "关","guān","shut; lock up; turn off; close down"
    "关系","guānxì","relation; relationship"
    "关心","guānxīn","be concerned with; care for"
    "馆","guǎn","an indoor place for activities"
    "广播","guǎngbō","broadcast; be on the air"
    "贵","guì","expensive; costly; dear"
    "贵姓","guì xìng","your honorable family name"
    "国","guó","country; state; nation"
    "国家","guójiā","country; state; nation"
    "过","guò","pass; spend time; go through"
    "过","guo","(indicate an action in the past)"
    "过来","guò lai","come over; come up"
    "过去","guòqù","the past; former times"
    "过去","guò qu","go over; pass by"
    "哈哈","hāhā","ha-ha (the sound of laughing)"
    "还","hái","still; yet; even more; also; fairly"
    "还是","háishì","still; nevertheless; had better; or"
    "孩子","háizi","child; children; son or daughter"
    "海","hǎi","sea"
    "寒假","hánjià","winter vacation"
    "喊","hǎn","shout; cry out; yell; call sb."
    "汉语","hànyǔ","Chinese; the Chinese language"
    ...
    "好处","hǎochu","good; advantage; benefit; gain"
    "好看","hǎokàn","good-looking; nice; pretty"
    "好像","hǎoxiàng","seem; look like; be like; as if"
    "号","hào","number; date"
    "喝","hē","drink"
    "和","hé","and; with; to"
    "合适","héshì","appropriate; right; suitable"
    "河","hé","river"
    "黑","hēi","black; dark"
    "黑板","hēibǎn","blackboard"
    "很","hěn","very; quite; awfully"
    "红","hóng","red; symbol of success"
    "后","hòu","back; rear; behind"
    "后边","hòubian","back; rear; behind; latter"
    ...
    "画","huà","draw; paint"
    "画儿","huàr","drawing; picture; painting"
    "化学","huàxué","chemistry"
    "话","huà","word; talk; speech; remark"
    "坏","huài","bad; go bad; spoil; ruin"
    "欢迎","huānyíng","welcome; greet; favorably receive"
    "还","huán","give back; return; give sth. in return"
    "换","huàn","exchange; barter; trade; change"
    "黄","huáng","yellow; sallow; fall through"
    ...
    "会","huì","can; be good at; be likely to; meet"
    "会","huì","meeting; gathering; conference"
    "会话","huìhuà","conversation; converse with"
    "活","huó","live"
    "活儿","huó","work"
    "活动","huódòng","move about; relax; activity; shaky"
    "火车","huǒchē","train"
    "或者","huòzhě","or; perhaps; maybe"
    "基本","jīběn","basic; fundamental; on the whole"
    "基础","jīchǔ","foundation; base; basis"
    "机场","jīchǎng","airport; airfield; aerodrome"
    ...
    "挤","jǐ","crowded; cram; jostle; squeeze"
    "几","jǐ","how many; a few; some"
    "技术","jìshù","technology; skill; technique"
    "寄","jì","send; post; mail"
    "计划","jìhuà","plan; project; program; map out"
    "记","jì","mark; remember; jot down; record"
    "继续","jìxù","continue; go on; continuation"
    "家(文学家)","jiā (wénxuéjiā)","(suffix) -ist; family; home; household"
    "家庭","jiātíng","family; household"
    "加","jiā","add; plus; increase; put in"
    "坚持","jiānchí","persist in; persevere in; stick to"
    "间","jiān","(measure word for rooms)"
    "检查","jiǎnchá","check up; inspect; self-criticism"
    "简单","jiǎndān","simple; commonplace; casual"
    "见","jiàn","meet; see; be exposed to"
    "见面","jiàn miàn","meet; see"
    "件","jiàn","(measure word for clothes, affairs)"
    "健康","jiànkāng","health; healthy; sound; wholesome"
    "建设","jiànshè","build; construct; construction"
    "将来","jiānglái","future"
    "江","jiāng","river"
    "讲","jiǎng","tell; speak; explain; discuss; stress"
    ...
    "接着","jiēzhe","then; afterward; follow"
    "街","jiē","street"
    "节","jié","festival; section; length"
    "节目","jiémù","program; item (on a program)"
    "节日","jiérì","festival; holiday"
    "结果","jiéguǒ","finally; at last; result; outcome"
    "结束","jiéshù","end; finish; conclude; wind up"
    "解决","jiějué","resolve; settle; solve"
    "姐姐","jiějie","elder sister"
    "借","jiè","borrow; lend; make use of"
    "介绍","jièshào","introduce; recommend; let know"
    "斤","jīn","half a kilogram"
    "今年","jīnnián","this year"
    "今天","jīntiān","today; present; now"
    "紧","jǐn","tight; urgent; hard up; tighten"
    "紧张","jǐnzhāng","nervous; tense; in short supply"
    "进","jìn","enter; come or go into; recruit"
    "进来","jìnlái","come in; get in"
    "进去","jìnqu","go in; get in; enter"
    "进行","jìnxíng","be in progress; go on; carry on"
    "近","jìn","nearby; near; close"
    "精彩","jīngcǎi","brilliant; splendid; wonderful"
    "精神","jīngshén","spirit; mind; gist; essence"
    "经常","jīngcháng","often; frequently; constantly; usually"
    "经过","jīngguò","pass; go through; as a result of"
    "经济","jīngjì","economy; income; economical"
    "经验","jīngyàn","experience"
    "久","jiǔ","for a long time; long"
    "九","jiǔ","nine"
    "酒","jiǔ","alcoholic drink; wine; liquor"
    "旧","jiù","old; past; bygone; used; worn"
    "就","jiù","with regard to; even if; at once"
    "橘子(桔子)","júzi","orange; tangerine; mandarin"
    "举","jǔ","lift; heave; raise; hold up; cite"
    "句","jù","(measure word for sentences)"
    "句子","jùzi","sentence"
    "觉得","juéde","feel; think"
    "决定","juédìng","decide; resolve; decision; resolution"
    "咖啡","kāfēi","coffee"
    "卡车","kǎchē","lorry; truck"
    "开","kāi","open; operate; turn on; hold; boil"
    ...
    "考试","kǎoshì","examine; test; examination"
    ...
    "客气","kèqi","polite; act or remark politely"
    "课","kè","lesson; class; subject; course"
    "课本","kèběn","textbook"
    "课文","kèwén","text"
    "空气","kōngqì","air"
    ...
    "冷","lěng","cold"
    "离","lí","leave; without; off; away; from"
    "离开","líkāi","leave; depart from"
    "里","lǐ","in; inside"
    "里","lǐ","half a kilometer"
    "里边","lǐbian","inside; in; within; interior"
    ...
    "俩","liǎ","two people (used in oral Chinese)"
    "联系","liánxì","integrate; link; contact; connection"
    "连…都(也)…","lián … dōu (yě) …","even"
    "脸","liǎn","face"
    "练习","liànxí","practice; exercise; drill"
    "凉快","liángkuai","nice and cool; pleasantly cool"
    "两","liǎng","two; a few; some"
    ...
    "零","líng","zero, 0"
    "领导","lǐngdǎo","lead; leader; leadership"
    ...
    "六","liù","six"
    "楼","lóu","storied building"
    "路","lù","road; path; way; journey; route"
    "录音","lùyīn","record sound; sound recording"
    "旅行","lǚxíng","travel; journey; tour; trip"
    "绿","lǜ","green"
    "乱","luàn","in a mess; indiscriminate; random"
    "妈妈","māma","mummy; mom; ma; mother"
    "麻烦","máfan","troublesome; put sb. to trouble"
    "马","mǎ","horse"
    "马上","mǎshàng","at once; immediately; right away"
    "嘛","ma","(modal particle expressing urging)"
    "吗","ma","(modal particle making a question)"
    "买","mǎi","buy; purchase"
    "卖","mài","sell"
    "满","mǎn","full; filled; complete; fill; expire"
    "满意","mǎnyì","satisfied; pleased"
    "慢","màn","slow"
    "忙","máng","busy; fully occupied"
    "毛","máo","one tenth of one RMB Yuan"
    "帽子","màozi","hat; cap"
    "没","méi","not have; there is not; not"
    "没关系","méi guānxi","never mind; it doesn't matter"
    "没意思","méi yìsi","uninteresting; dull"
    "没有","méiyǒu","not have; there is not; not"
    "每","měi","every; each; per; every time"
    "妹妹","mèimei","younger sister"
    "门","mén","entrance; door; gate"
    "门口","ménkǒu","entrance; doorway"
    "们(朋友们)","men (péngyoumen)","(particle forming a plural pronoun)"
    ...
    "能够","nénggòu","can; be able to; be capable of"
    "嗯","ng","(interjection expressing what or huh)"
    "你","nǐ","you (the singular form)"
    "你们","nǐmen","you (the plural form)"
    ...
    "七","qī","seven"
    "骑","qí","ride (an animal or bicycle)"
    ...
    "浅","qiǎn","shallow; simple; superficial; light"
    "墙","qiáng","wall"
    "桥","qiáo","bridge"
    "青年","qīngnián","young person; youth"
    "轻","qīng","light; small in number, degree, etc."
    "清楚","qīngchu","clear; distinct; be clear about"
    "晴","qíng","clear; sunny"
    "情况","qíngkuàng","circumstance; situation, condition"
    "请","qǐng","please; request; ask; invite; engage"
    ...
    "全体","quántǐ","all; whole; entire"
    "确实","quèshí","true; reliable"
    "然后","ránhòu","then; afterwards; after that"
    "让","ràng","give way; give ground; invite; let"
    "热","rè","hot; popular; heat up; warm"
    "热情","rèqíng","warm; fervent; enthusiasm"
    "人","rén","person; man; people"
    "人们","rénmen","persons; people; the public"
    "人民","rénmín","the people"
    "任何","rènhé","any; whichever; whatever"
    "认识","rènshi","recognize; understand; cognition"
    "认为","rènwéi","think; consider"
    "认真","rènzhēn","conscientious; earnest; serious"
    "日","rì","sun; day time; a day of the month"
    "日语(日文)","rìyǔ(rìwén)","Japanese (language)"
    ...
    "上边","shàngbian","above; over; the higher authorities"
    ...
    "什么","shénme","what; whatever; why; something"
    "声","shēng","(measure word for sound); sound"
    "声调","shēngdiào","tone; the tone of Chinese character"
    "声音","shēngyīn","sound; voice"
    "生产","shēngchǎn","produce; manufacture; production"
    "生词","shēngcí","new word"
    "生活","shēnghuó","life; livelihood; live; exist"
    "生日","shēngrì","birthday"
    "省","shěng","province"
    "剩","shèng","surplus; remnant; leave (over)"
    "胜利","shènglì","victory; triumph"
    "师傅","shīfu","master worker; master; teacher"
    "十","shí","ten"
    "十分","shífēn","very; fully; utterly; extremely"
    "时候","shíhou","time; when"
    "时间","shíjiān","when"
    "食堂","shítáng","dining room; canteen; cafeteria"
    "实践","shíjiàn","live up to; carry out; practice"
    ...
    "首都","shǒudū","capital"
    "输","shū","transport; convey; lose; be beaten"
    "舒服","shūfu","comfortable"
    "书","shū","book"
    "熟","shú","ripe; cooked; done; familiar"
    "数","shǔ","count; be reckoned as"
    "树","shù","tree"
    "数学","shùxué","mathematics"
    "双","shuāng","pair; twin; dual; double; di-; bi-"
    "谁","sheí/shuí","who"
    "水","shuǐ","water"
    "水果","shuǐguǒ","fruit"
    ...
    "岁","suì","years old (for a person's age)"
    "所以","suǒyǐ","so; therefore; as a result"
    "所有","suǒyǒu","all"
    "他","tā","he"
    "他们","tāmen","they; them (for males and females)"
    "它","tā","it"
    "它们","tāmen","they; them (for things, animals, etc.)"
    "她","tā","she"
    ...
    "通过","tōngguò","by way of; through; pass through"
    ...
    "现代","xiàndài","modern times; the contemporary age"
    ...
    "响","xiǎng","make a sound; ring; noisy; loud"
    ...
    "许多","xǔduō","many; much; a lot of"
    "学","xué","study; learn; imitate; mimic"
    "学生","xuésheng","student; schoolboy; schoolgirl"
    "学习","xuéxí","study; learn; emulate"
    "学校","xuéxiào","school; educational institute"
    ...
    "艺术","yìshù","art; skill; craft"
    "亿","yì","a hundred million"
    "意见","yìjiàn","opinion; view; objection"
    "意思","yìsi","meaning; idea; wish; appreciation"
    "意义","yìyì","meaning; sense; significance"
    "因为","yīnwèi","because; on account of; because of"
    "音乐","yīnyuè","music"
    "阴","yīn","cloudy; overcast; sinister"
    "银行","yínháng","bank"
    "英语(英文)","yīngyǔ(yīngwén)","English (language)"
    "应该","yīnggāi","ought to; should; must"
    "赢","yíng","win; beat; gain"
    "影响","yǐngxiǎng","influence; affect; effect"
    "永远","yǒngyuǎn","for good; forever; ever; always"
    ...
    "月球","yuèqiú","the moon"
    "云","yún","cloud"
    "运动","yùndòng","be in motion; move about; sport"
    "再","zài","again; not … until; then and only then"
    "再见","zàijiàn","good-bye; see you again"
    ...
    "早饭","zǎofàn","breakfast"
    "怎么","zěnme","how; why; however"
    "怎么样","zěnmeyàng","how; (a polite formula)"
    "怎样","zěnyàng","how"
    ...
    "整齐","zhěngqí","in good order; neat; tidy"
    ...
    "只","zhī","(measure word for one of a pair)"
    ...
    "中间","zhōngjiān","center; middle; among; between"
    "中文","zhōngwén","Chinese (language)"
    "中午","zhōngwǔ","noon; midday"
    "中学","zhōngxué","middle school; high school"
    "钟","zhōng","bell; clock"
    "钟头","zhōngtóu","hour (mainly used in oral Chinese)"
    "种","zhǒng","kind; type; sort; breed; race; strain"
    ...
    "装","zhuāng","act; pretend; load; assemble; fit"
    "准备","zhǔnbèi","prepare; get ready (for); intend"
    "桌子","zhuōzi","table; desk"
    "自己","zìjǐ","oneself; closely related; own"
    "自行车","zìxíngchē","bike; bicycle"
    "字","zì","word; character"
    "总(是)","zǒng(shì)","put together; general; chief; always"
    "走","zǒu","walk; visit; pass; leave; go away"
    "足球","zúqiú","football game; soccer ball"
    "祖国","zǔguó","motherland; fatherland; homeland"
    "组织","zǔzhī","organize; form; organization"
    "嘴","zuǐ","mouth"
    "最","zuì","most"
    "最初","zuìchū","first; initial"
    "最后","zuìhòu","last; final; ultimate"
    ...
    "作业","zuòyè","homework; operation; task; work"
    ...
    const data = lines.slice(1).reduce((map, line) => {
        const values = line.replace(/"/g, '').split(',');

        const hanzi = values[0];
        const pinyin = values[1];
